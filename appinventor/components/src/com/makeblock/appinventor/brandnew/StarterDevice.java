...
public class StarterDevice extends RJ25Device {
    ...
    public StarterDevice(FirmwareRespond firmwareRespond) {
        super("orion", "Starter / Ultimate", firmwareRespond);
    }

    @Override
    protected void handleRespond(RJ25Respond rj25Respond) {
        Log.e("wbp", "Starter device receive respond:" + rj25Respond.toString());
